...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-8 text-white bg-slate-900">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-gray-400">JobLine<span className='text-gray-600'>  Careers Pvt. Ltd.</span></h2>
            <p className="text-sm text-gray-600">© 2024 JobLine Careers Pvt. Ltd.  All rights reserved.</p>
         <p className='text-gray-600'>Privacy Policy | Terms of Service | Customer Support dial +91 1234567890</p>
          </div>
